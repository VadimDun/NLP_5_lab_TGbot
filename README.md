# NLP_5_lab_TGbot
Репозиторий для лабораторной работы №5 "Создание Telegram-бота с поддержкой контекста на основе локальной LLM" по дисциплине "Обработка естественного языка".
